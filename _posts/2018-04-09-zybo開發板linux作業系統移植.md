...
2.启动SDK![](/home/huang/圖片/vivado/1.png "启动SDK") 


3.在SDK的file选单选择New->Application Project.![ ](/home/huang/圖片/vivado/2.png  "建立Application Project")


4.在会话框中，Project name可以随便填,OS Platform选择standalone,Hardware Platform默认是my_wrapper_hw_platform_0,根据实际选择对应的Hardware Platform,并点击next进入下一步。![](/home/huang/圖片/vivado/3.png) 


5.在Templates单里选择Zynq FSBL,之后点击Finish。![](/home/huang/圖片/vivado/4.png) 


6.在SDK左侧栏目中，右击刚刚建立的FSBL项目，在弹出的选单中选择Buid Project.![](/home/huang/圖片/vivado/5.png) 


7,在SDK顶部工具栏点击Create Zynq Boot Image。![](/home/huang/圖片/vivado/6.png) 



8.在Create Zynq Boot Image对话框中，点击Add添加上面制作好的u-boot.elf文件，添加后点击OK.![](/home/huang/圖片/vivado/7.png) 
