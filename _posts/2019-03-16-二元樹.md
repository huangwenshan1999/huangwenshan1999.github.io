...
![ ](https://github.com/huangwenshan1999/huangwenshan1999.github.io/raw/master/post_imgbinary-tree/BST-preOrder.png  "PreOrder")
...
![](https://github.com/huangwenshan1999/huangwenshan1999.github.io/raw/master/post_imgbinary-tree/BST-InOrder_p29.png  "InOrder")
...
![ ](https://github.com/huangwenshan1999/huangwenshan1999.github.io/raw/master/post_imgbinary-tree/BST-OostOrder_p28.png  "PostOrder")
...
bool remove(node **root, int value) {
 ...
 //        node *smallest = findSmallest(nodeToRemove->right);  //查找nodeToRemove的右節點的最小值
//         node *smallesetParent = findParent(smallest, smallest->data); //找到此最小值的父節點
 //        smallesetParent->left = smallest->right;  //把最小值節點的右節點賦值給smallest父節點的左子樹
//         nodeToRemove->data = smallest->data;    //使用最小值smallest->data替換nodeToRemove->data
 //        delete smallest;  //刪除之

        node *largest = findLargest(nodeToRemove->left);   //查找nodeToRemove的左節點的最大值
        node *largestParent = findParent(largest, largest->data);   //找largest的父節點
        largestParent->right = largest->left;  //largest只有左節點，否則它就不是最大值。把largest的左節點和largestParent的右節點連接
        nodeToRemove->data = largest->data;    //使用最大值largest->data替換nodeToRemove的值
...
```
圖解如下:
![ ](https://github.com/huangwenshan1999/huangwenshan1999.github.io/raw/master/post_imgbinary-tree/BST-Remove.jpeg  "Remove")
